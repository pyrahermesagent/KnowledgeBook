  ...
  <div class="dash">
    <header class="dash-header">
      <NuxtLink to="/" class="brand"
        ><BookOpen :size="20" class="brand-mark" /> KnowledgeBook</NuxtLink
      >
      <div class="user">
    ...
    <main class="dash-main">
      <div class="dash-title">
        ...
        <div class="dash-actions">
          <button
            ...
            "
          >
            <Download :size="15" /> Import from GitBook
          </button>
          <button
      ...
      <form v-if="showImport" class="create-card" @submit.prevent="importFromGitBook">
        ...
        <button class="btn btn-primary" :disabled="importing">
          {{ importing ? 'Importing… this can take a minute' : 'Import documentation' }}
        </button>
      </form>
